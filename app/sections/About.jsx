    ...
    <section className={styles.about__section}>
        ...
        <div className={styles.about__top}>
          <div className={styles.about__sub_header}>
            <h6 data-animation="paragraph">
              We transcends expectations and propels you to the undisputed
          ...
          <div className={styles.about__main_paragraph}>
            <div className={styles.about__main_paragraph_first}>
              <p data-animation="paragraph">
                We are the language of champions.
              </p>
            </div>
            <div className={styles.about__main_paragraph_second}>
              <p data-animation="paragraph">
                LVI Media is more than just a video production company. We are
                the chroniclers of legends in the making
              </p>
            </div>
            <div className={styles.about__main_paragraph_third}>
              <p data-animation="paragraph">
                We are the bards who weave tales of athletic prowess and
                unwavering spirit. In every frame we capture, every sequence we
                craft, we distil the very essence of what it means to be a
                champion
              </p>
      ...
      <section className={styles.about__consumer_section}>
        <div className={styles.about__consumer_main}>
          <div
            className={styles.about__consumer_headline}
            data-animation="fade"
          >
            <span />
          ...
          <div className={styles.about__consumer_header}>
            <h1 data-animation="paragraph">
              92% of consumers watch videos with the sound{" "}
              <span className={styles.off__word}>
                off
